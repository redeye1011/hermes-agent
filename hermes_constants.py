...
def is_container() -> bool:
    ...
    try:
        ...
        pass
    # cgroup v2: /proc/1/cgroup is just "0::/" with no marker. The current
    # process's root mount still names the runtime; ignore Docker storage mounted
    # elsewhere on a normal host.
    try:
